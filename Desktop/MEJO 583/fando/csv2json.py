...
file_name = 'vimport csv
import json

# https://docs.python.org/2/library/csv.html
file_name = '27516-2018-04-22-movie-results.csv' # change to the csv file name that you are trying to upload
with open(file_name) as csvfile:
    csvfile = csv.DictReader(csvfile)
    app_name = 'fandango' # change this to your Django app name
    model_name = 'Theatre' # the name of you Django model
...
#     }
#   }
# ].csv' # change to the csv file name that you are trying to upload
with open(file_name) as csvfile:
    csvfile = csv.DictReader(csvfile)
